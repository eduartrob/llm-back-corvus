...
# Revert to the original strict fallback behavior
...
content = content.replace('models_to_try = get_models_to_try(groq_model)', 'models_to_try = [groq_model] + [m for m in FALLBACK_MODELS if m != groq_model]')
