...
async def generate_gemini_json(system_prompt: str, user_prompt: str, api_key: str, model: str = "gemini-2.5-flash") -> dict:
    """
    ...
    try:
        logger.info(f"[GeminiClient] Generando JSON estructurado con Gemini {model}...")
        async with httpx.AsyncClient() as client:
